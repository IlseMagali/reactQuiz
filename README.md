...
This README.md was created by Pluralsight on React Fundamentals course, as well this project is build based on pluralsight course related to React Fundamentals.